...
before packages are loaded."
  ...
  (define-key evil-normal-state-map (kbd ",k") 'symbol-overlay-put)
  (define-key evil-normal-state-map (kbd ",/") 'evil-commentary-line)
  (define-key evil-visual-state-map (kbd ",/") 'evil-commentary-line)
